...
export const metadata: Metadata = {
  title: "SMS Marketing — Bulk SMS Campaigns & Audience Segmentation",
  ...
  openGraph: { title: "SMS Marketing Platform — Bulk Campaigns & Segmentation | Net2APP", description: "Targeted SMS marketing with subscriber lists, audience segmentation, and campaign analytics." },
};
...
const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://net2app.com/solutions/use-cases/sms-marketing#webpage",
        "url": "https://net2app.com/solutions/use-cases/sms-marketing",
        "name": "SMS Marketing — Bulk SMS Campaigns & Audience Segmentation",
        "description": "Build subscriber lists, create audience segments, and run targeted SMS marketing campaigns with delivery analytics.",
        "breadcrumb": {
          "@type": "BreadcrumbList",
          "itemListElement": [
            {
            ...
            },
            {
              ...
              "position": 3,
              "name": "SMS Marketing",
              "item": "https://net2app.com/solutions/use-cases/sms-marketing"
            }
          ]
        }
      },
      {
        "@type": "FAQPage",
        "@id": "https://net2app.com/solutions/use-cases/sms-marketing#faq",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "How do I build a subscriber list for SMS marketing?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Net2APP provides subscriber list management tools where you can add contacts manually, import from CSV, or integrate with your CRM via API. All subscribers must opt-in for compliance with TCPA and GDPR regulations. The platform tracks opt-in status and consent timestamps."
            }
          },
          {
            "@type": "Question",
            "name": "Can I segment my audience for targeted campaigns?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes. Create audience segments based on demographics, purchase history, engagement level, location, and custom attributes. Send targeted campaigns that deliver personalized messages to each segment for higher conversion rates."
            }
          },
          {
            "@type": "Question",
            "name": "How do I measure the success of my SMS campaigns?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Net2APP provides real-time campaign analytics including delivery rates, click-through rates, conversion tracking, and ROI analysis. View campaign performance by segment, time period, and message type in the analytics dashboard."
            }
          }
        ]
      }
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-12 pt-16 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight mb-4">SMS Marketing</h1>
            <p className="text-lg text-gray-600 leading-relaxed mb-6">Build subscriber lists, create audience segments, and run targeted SMS marketing campaigns. Deliver exclusive offers, product launches, and personalized recommendations directly to mobile phones.</p>
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-8 shadow-sm">
            ...
            <ul className="space-y-3">{["Subscriber list management", "Audience segmentation tools", "Automated campaign triggers", "Personalized message templates", "Performance analytics"].map((f, i) => (
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Grow Your Reach</h2>
          <p className="text-blue-100 text-lg mb-8">Launch your SMS marketing platform in under 60 seconds.</p>
