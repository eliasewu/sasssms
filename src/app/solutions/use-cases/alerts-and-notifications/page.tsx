...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "DLR Alert Tracking",
    "Priority SMS Notification",
    "Class 0 SMS Alert",
    "Emergency Broadcast System",
    "Alert Delivery Platform",
    "SMS Alert Bangladesh",
    "SMS Notification India",
    "SMS Alert UAE",
...
const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://net2app.com/solutions/use-cases/alerts-and-notifications#webpage",
        "url": "https://net2app.com/solutions/use-cases/alerts-and-notifications",
        "name": "Alerts & Notifications — SMS, Flash SMS & Emergency Broadcasts",
        "description": "Send system alerts, status updates, emergency broadcasts, and critical notifications via SMS and Flash SMS with priority delivery.",
        "breadcrumb": {
          "@type": "BreadcrumbList",
          "itemListElement": [
            {
            ...
            },
            {
              ...
              "item": "https://net2app.com/solutions/use-cases/alerts-and-notifications"
            }
          ]
        }
      },
      {
        "@type": "FAQPage",
        "@id": "https://net2app.com/solutions/use-cases/alerts-and-notifications#faq",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What is Flash SMS and when should I use it?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Flash SMS (Class 0) appears as an instant screen pop-up on the recipient's phone without being saved to the inbox. Use it for urgent alerts, emergency broadcasts, and critical notifications that require immediate attention and cannot be ignored."
            }
          },
          {
            "@type": "Question",
            "name": "Can I schedule alerts in advance?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes. Net2APP supports scheduled alert delivery. You can configure alerts to be sent at specific times or on recurring schedules through the API, making it ideal for planned maintenance notifications and regular status updates."
            }
          },
          {
            "@type": "Question",
            "name": "How do I track whether alerts were delivered?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Net2APP provides DLR (Delivery Report) tracking for all SMS alerts. You receive real-time webhook callbacks when messages are delivered, undelivered, or fail. Status codes include DELIVERED, UNDELIVERABLE, EXPIRED, and more."
            }
          }
        ]
      }
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-12 pt-16 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight mb-4">Alerts & Notifications</h1>
            <p className="text-lg text-gray-600 leading-relaxed mb-6">Send system alerts, status updates, emergency broadcasts, and critical notifications. Use Flash SMS (Class 0) for messages that appear as instant screen pop-ups that cannot be ignored.</p>
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-8 shadow-sm">
            ...
            <ul className="space-y-3">{["Flash SMS priority delivery", "System status notifications", "Emergency broadcast capability", "Scheduled alert delivery", "DLR confirmation tracking"].map((f, i) => (
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Never Miss a Critical Alert</h2>
          <p className="text-blue-100 text-lg mb-8">Deploy your alert system in under 60 seconds.</p>
