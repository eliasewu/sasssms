...
export const metadata: Metadata = {
  title: "Customer Data Management — SMS Surveys & Feedback Collection",
  ...
  keywords: [
    ...
    "Interactive SMS Survey",
    "Real-Time Data Collection",
    "Customer Feedback SMS",
    "SMS Poll",
    "SMS Voting",
    "Data Export SMS",
    "Customer Data Bangladesh",
    "SMS Survey India",
    "SMS Feedback UAE",
    "SMS Data Platform",
    "Customer Insights SMS",
  ],
  openGraph: { title: "Customer Data Management — SMS Data Collection | Net2APP", description: "Collect customer data via SMS surveys, feedback forms, and real-time response enrichment." },
};
...
const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://net2app.com/solutions/use-cases/customer-data-management#webpage",
        "url": "https://net2app.com/solutions/use-cases/customer-data-management",
        "name": "Customer Data Management — SMS Surveys & Feedback Collection",
        "description": "Collect customer data via SMS surveys, feedback forms, and interactive messaging. Enrich customer profiles with real-time responses.",
        "breadcrumb": {
          "@type": "BreadcrumbList",
          "itemListElement": [
            {
            ...
            },
            {
              ...
              "item": "https://net2app.com/solutions/use-cases/customer-data-management"
            }
          ]
        }
      },
      {
        "@type": "FAQPage",
        "@id": "https://net2app.com/solutions/use-cases/customer-data-management#faq",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "What kinds of data can I collect via SMS?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "You can collect survey responses, customer feedback, satisfaction ratings (NPS), preference data, demographic information, and behavioral insights through interactive SMS flows. Responses are captured in real-time and can be exported to your CRM or data warehouse."
            }
          },
          {
            "@type": "Question",
            "name": "How do SMS surveys work?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Send a survey link or interactive SMS question to customers. They reply directly via SMS, and Net2APP captures and stores the responses. Survey flows can include branching logic, multiple questions, and follow-up messages based on answers."
            }
          },
          {
            "@type": "Question",
            "name": "Can I integrate SMS data with my existing systems?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes. Net2APP provides webhook callbacks and API endpoints for real-time data export. Integrate collected data with your CRM, CDP, data warehouse, or analytics platform for unified customer profiles."
            }
          }
        ]
      }
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 lg:px-12 pt-16 pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight mb-4">Customer Data Management</h1>
            <p className="text-lg text-gray-600 leading-relaxed mb-6">Collect customer data via SMS surveys, feedback forms, and interactive messaging. Enrich customer profiles with real-time responses and behavioral data.</p>
          ...
          <div className="bg-gray-50 border border-gray-100 rounded-2xl p-8 shadow-sm">
            ...
            <ul className="space-y-3">{["SMS survey collection", "Real-time data enrichment", "Customer profile updates", "Feedback form automation", "Data export and analytics"].map((f, i) => (
      ...
      <section className="py-20 bg-gradient-to-r from-orange-600 to-amber-600">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Know Your Customers</h2>
          <p className="text-blue-100 text-lg mb-8">Deploy SMS data collection in under 60 seconds.</p>
          <a href="https://net2app.com" className="inline-block px-10 py-4 bg-white text-orange-600 rounded-xl hover:bg-blue-50 transition font-semibold text-lg shadow-xl">Deploy Your Instance Free →</a>
        </div>
      </section>
